...
const Level3 = ({ setPage, player, setPlayer }) => {
  const level = useRef();
  ...
  return (
    <div className="level" ref={level}>
      <div className="level__wrapper">
        ...
        <img
          src="https://res.cloudinary.com/duykdzv1k/image/upload/v1624725579/level_03_3x_fe8f9187d9.png"
          alt=""
